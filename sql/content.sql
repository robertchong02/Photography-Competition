...
CREATE TABLE `content` (
  ...
  `ContentImage` longblob NOT NULL,
...
--
ALTER TABLE `content`
  MODIFY `ContentID` int(255) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `content`
  ADD CONSTRAINT `content_ibfk_1` FOREIGN KEY (`CompetitionID`) REFERENCES `competition` (`CompetitionID`);
COMMIT;
